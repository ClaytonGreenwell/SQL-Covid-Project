...
/* This is a portfolio project that uses a COVID-19 public dataset to demonstrate knowledge of Joins, CTEs, Aggregate Functions, Creating Views, and Converting data types. This is based off a SQL tutorial created by "Alex the Analyst", and is explored here with explicit permission. I am using the sandbox version of BigQuery, and then using RSQLite to export to a .sql file, as this isn't available in BigQuery sandbox.
*/
